...
users = pd.read_csv('D:\\TCC_2\\ml-100k\\u.user', sep="|", names=u_cols, encoding='latin-1')

r_cols = ['user_id', 'movie_id', 'rating', 'unix_timestamp']
ratings = pd.read_csv('D:\\TCC_2\\ml-100k\\u.data', sep='\t', names=r_cols, encoding='latin-1')
...
result.to_csv("D:\\TCC_2\\ml-100k\\groups_rand_sz"+str(size)+".csv",sep="\t",encoding='utf8')
